// Rehashing.java - (insert one line description here)
...
public class Rehashing
{
    ...
    public static class Map<K, V>
    {
        ...
        private int getBucketInd(final K key)
        {
        ...
        public void insert(final K key, final V value)
        {
            ...
            final int bucketInd = getBucketInd(key);
            ...
            final MapNode<K, V> newElementNode = new MapNode<K, V>(key, value);
            ...
            final double loadFactor = (1.0 * size) / numBuckets;
        ...
        private void rehash()
        {
            ...
            final ArrayList<MapNode<K, V>> temp = buckets;
    ...
    public static void main(final String[] args)
    {
        ...
        // Creating the Map
        final Map<Integer, String> map = new Map<Integer, String>();
